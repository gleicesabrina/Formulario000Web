...
<body>
    ...
    <div class="form-row">
        ...
        <form form-control form-control-sm method="post" action="../controller/ControllerEditar.php" id="form" name="form" onsubmit="validar(document.form); return false;" class="col-10">
            ...
            <div class="form-group">
                <div class="mx-auto" style="width: 500px;">
                    <label for="status">Status do livro</label></br>
                    <select name="flag">
